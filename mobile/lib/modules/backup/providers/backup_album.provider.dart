...
class BackupAlbums extends _$BackupAlbums {
  ...
  Future<void> _updateAlbumSelection(
    ...
    await db.writeTxn(() async {
      db.backupAlbums.store(backupAlbum);
      db.assets.putAll(assets);
    });

    ref.invalidateSelf();
  }

  Future<void> addAlbumForBackup(LocalAlbum album) =>
  ...
  Future<void> removeAlbumFromBackup(LocalAlbum album) =>
